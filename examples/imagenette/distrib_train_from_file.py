...
#
# Run with:
# python -m torch.distributed.launch --nproc_per_node=NUM_GPUS distrib_train_from_file.py -a resnet50 --dali_cpu --b 128 --loss-scale 128.0 --workers 4 --lr=0.4 --opt-level O2 /tmp/imagenette2-320/train /tmp/imagenette2-320/val
